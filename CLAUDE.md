...
|---------|-----------|----------|------------------|-----------------|-------------|-------------|
| **Game** | GameAggregate | ✅ Create/Start/PickUp (8081) | GameCreated, PlayerAdded, CardsRequestedToDealer, CardPickedFromDeck, CardsPickedFromDiscardPile | PlayerCreated, CardDealt* (5 types) | None | KurrentDB: game-{id} |
