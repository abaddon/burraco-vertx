...
internal class Given_existingDealer_When_DealCardToDiscardDeckWithWrongGamId_Then_exception : KcqrsAggregateTestSpecification<Dealer>(){
    companion object{
        val AGGREGATE_ID = DealerIdentity.create()
        val PLAYER_ID1= PlayerIdentity.create()
        val PLAYER_ID2= PlayerIdentity.create()
...
internal class Given_existingDealerWithDealCardToDiscardDeck_When_DealCardToDiscardDeck_Then_exception : KcqrsAggregateTestSpecification<Dealer>(){
    companion object{
        val AGGREGATE_ID = DealerIdentity.create()
        val PLAYER_ID1= PlayerIdentity.create()
        val PLAYER_ID2= PlayerIdentity.create()
    ...
    override fun expectedException(): Exception? = IllegalStateException("The discard deck has the maximum number of cards (1)")
}