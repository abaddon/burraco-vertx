...
internal class Given_existingDealer_When_DealCardToPlayerDeck1_Then_event : KcqrsAggregateTestSpecification<Dealer>() {
    ...
    override fun `when`(): ICommand<Dealer> = DealCardToPlayerDeck1(aggregateId, gameIdentity = GAME_ID)

    override fun expected(): List<IDomainEvent> = listOf(
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.first())
    )
...
internal class Given_existingDealer_When_DealCardToPlayerDeck1WithWrongGamId_Then_exception :
    ...
    override fun `when`(): ICommand<Dealer> = DealCardToPlayerDeck1(aggregateId, gameIdentity = WRONG_GAME_ID)
...
internal class Given_existingDealerWith4PlayerWithDealCardToPlayerDeck1WithMaxCards_When_DealCardToPlayerDeck1_Then_exception :
    ...
    override fun given(): List<IDomainEvent> = listOf<DealerEvent>(
        DeckCreated.create(AGGREGATE_ID, GAME_ID, PLAYERS, CARDS),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(0)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(1)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(2)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(3)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(4)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(5)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(6)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(7)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(8)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(9)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(10))
    )
...
internal class Given_existingDealerWith3PlayerWithDealCardToPlayerDeck1WithMaxCards_When_DealCardToPlayerDeck1_Then_event :
    ...
    override fun given(): List<IDomainEvent> = listOf<DealerEvent>(
        ...
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(10)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(11)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(12)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(13)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(14)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(15)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(16)),
        CardDealtToPlayerDeck1.create(aggregateId, GAME_ID, CARDS.elementAt(17))
    )
