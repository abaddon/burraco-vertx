...
class AddPlayerRoutingHandler(private val controllerAdapter: CommandControllerPort): RoutingHandler {
    ...
    override fun handle(routingContext: RoutingContext) {
        ...
        when (val outcome: Outcome = controllerAdapter.addPlayer(gameIdentity,playerIdentity)) {
